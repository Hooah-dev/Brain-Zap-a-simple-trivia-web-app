...
app.post('/index', async (req, res) => {
  ...
  axios.post('https://trivialapp-043f.restdb.io/rest/punteggio-giocatori', playerData, { headers: { "x-apikey": "5f046bd8a529a1752c476e5d", "content-type": "application/json", "cache-control": "no-cache" } })
    .then(() => { }
    )
...
app.get('/results/completeLeaderboard', (req, res) => {
  let playersData;
  axios
    .get('https://trivialapp-043f.restdb.io/rest/punteggio-giocatori', { headers: { "x-apikey": "5f046bd8a529a1752c476e5d", "content-type": "application/json", "cache-control": "no-cache" } })
